 ...
 ***************************************************************
 *  $Authors : Tom Stanis / Jeff Molofee 2000
 *  $Name:  $
 ***************************************************************
 *
...
*
* \file            Lesson08.c
* \author          Tom Stanis / Jeff Molofee 2000 ( NeHe ) originely, Modified for LCCWin32 compiler by Robert Wishlaw 2002/11/23
...
#include "resource.h"       // needed for function LoadImage who define an icon during CreateWindowsEx
...
BOOL CreateGLWindow(char* title, int width, int height, int bits, BOOL fullscreenflag)
{
	...
	wc.hIcon			= (HICON)LoadImage(GetModuleHandle(NULL), MAKEINTRESOURCE(IDC_MYICON), IMAGE_ICON, 0, 0, LR_DEFAULTSIZE );			// Load The Icon defined in resource file
