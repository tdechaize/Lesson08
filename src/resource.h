...
#define VER_FILEDESCRIPTION_STR 	"NeHe Lesson08 OpenGL\0"
#define VER_INTERNALNAME_STR 		"Lesson08\0"
...
#define VER_ORIGINALFILENAME_STR 	"Lesson08.exe\0"
// #define VER_PRODUCTNAME_STR 		"Lesson08 OpenGL : Texture mapping on cube in rotation.\0"
